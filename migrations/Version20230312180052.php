 ...
 */
final class Version20230312180052 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE classrooms_id classroom_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE student CHANGE classroom_id classrooms_id INT DEFAULT NULL');
